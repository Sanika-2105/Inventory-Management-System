...
PreparedStatement pstmt=con.prepareStatement("select * from vapply_raw where status=?");
...
%>
			...
			<%
			PreparedStatement pstmt2=con.prepareStatement("delete from vapply_raw where status=?");
			...
			<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
			   <div class="menu">
						...
						<li id="menu-academico" ><a href="charts.html"><i class="fa fa-bar-chart"></i><span>Charts</span><div class="clearfix"></div></a></li>-->									 
							  ...
							  <li id="menu-academico" ><a href="SuperApprovedRequest.jsp"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i><span>Approved Vendor Requests</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>	
