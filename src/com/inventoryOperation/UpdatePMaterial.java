...
/**
 * Servlet implementation class UpdatePMaterial
 */
public class UpdatePMaterial extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdatePMaterial() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			PreparedStatement pstmt=con.prepareStatement("select * from processed_item where id=?");
			pstmt.setInt(1,id );
			...
			PreparedStatement stmt=con.prepareStatement("update processed_item set quantity=? where id=?");
			...
			if(i>0)
			{
				response.sendRedirect("viewProcessedM.jsp");
			}
