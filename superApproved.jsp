...
PreparedStatement pstmt=con.prepareStatement("update vapply_raw set status=? where sr_no=?");
pstmt.setString(1,status);
pstmt.setInt(2,sr_no);

int i=pstmt.executeUpdate();
	
PreparedStatement pstmt2=con.prepareStatement("select * from vapply_raw where sr_no=?");
pstmt2.setInt(1,sr_no);
