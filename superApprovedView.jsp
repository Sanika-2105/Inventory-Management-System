...
<div class="agile-grids">	
				 ...
				 int id=0,quantity=0,cpu=0;
				 String name=null,unit=null;
				 int sr_no=Integer.parseInt(request.getParameter("srno"));
				 PreparedStatement pstmt=con.prepareStatement("select * from vapply_raw where sr_no=?");
				 ...
				 /*PreparedStatement pstmt2=con.prepareStatement("update raw_material set quantity=? and unit=? and costpu=? where id=?");
				 ...
				 */
				 ...
				 <div class="agile-tables">
					<div class="w3l-table-info">
					  <h2> Vendor  Approved Requests for Raw Material</h2>
					    <table id="table">
						<thead>
						  <tr>
							<th>Vendor-email</th>
