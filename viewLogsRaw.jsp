		...
		<header class="logo1">
			...
			<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
			   <div class="menu">
						...
						<li id="menu-academico" ><a href="viewLogsRaw.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i><span>View Logs Raw </span><div class="clearfix"></div></a></li>
						<li id="menu-academico" ><a href="errorpage.html"><i class="fa fa-angle-right" aria-hidden="true"></i><span>Issue Processed Material</span><div class="clearfix"></div></a></li>
						<li id="menu-academico" ><a href="errorpage.html"><i class="fa fa-angle-right" aria-hidden="true"></i><span>View Logs Processed</span><div class="clearfix"></div></a></li>
						  <li id="menu-academico" ><a href="#"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i><span> Show Unavailable Items</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
							   <ul id="menu-academico-sub" >
							   <li id="menu-academico-avaliacoes" ><a href="button.html">Raw</a></li>
								<li id="menu-academico-avaliacoes" ><a href="grid.html">Processed</a></li>
							  </ul>
							</li>
...
PreparedStatement pstmt=con.prepareStatement("select * from LogsRaw");
ResultSet rs=pstmt.executeQuery();
%>

					<div class="w3l-table-info">
					  <h2>Logs Raw Details</h2>
					    <table id="table">
						<thead>
						  <tr>
							<th>Issuer-id</th>
