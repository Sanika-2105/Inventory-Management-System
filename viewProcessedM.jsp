...
PreparedStatement pstmt=con.prepareStatement("select * from processed_item");
ResultSet rs=pstmt.executeQuery();
%>

				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2> Processed Material Details</h2>
					    <table id="table">
						<thead>
						  <tr>
							<th>Serial Number</th>
						...
						<tbody>
						  <tr>
							...
							<td><%=rs.getInt(6)%></td>
					 <td><a href="deletePM.jsp?sid=<%=rs.getInt(1)%>">delete</a></td>
						  </tr>
						</tbody>
						 <%} %>
					  </table>
